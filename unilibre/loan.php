...
//   $block_name = remove_junk($db->escape($_POST['block-name']));
   if(empty($errors)){
      $sql  = "INSERT INTO loans (init_date, end_date, finisihed, id_sucursal, id_block, id_producto)";
      $sql .= " VALUES ('{$_POST["init_date"]} {$_POST["init_time"]}', '{$_POST["end_date"]} {$_POST["end_time"]}', 0, '{$_POST["sucursal"]}', '{$_POST["bloque"]}', '{$_POST["producto"]}')";
      if($db->query($sql)){
